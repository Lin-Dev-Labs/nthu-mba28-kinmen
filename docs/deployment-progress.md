...
2. `public/reports/`、`public/graduation/`、`public/images/courses/` 目前都是空的，需陸續上傳分組報告、畢業證書/論文、課堂照片
   - **上傳前的隱私檢查**：畢業證書需馬賽克身分證字號/出生年月日；分組報告要確認沒有真實公司機密資料；課堂照片要取得同學同意、必要時去除 EXIF 定位資訊
3. 建議實際點過每個頁面（課程列表、單堂課、下載、畢業證書）確認在正式部署環境（有 basePath 子路徑）下圖片與連結都正常，不只在本機開發環境測試
